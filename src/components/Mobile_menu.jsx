          ...
          <MDBNavbarNav left>
            <MDBNavItem active>
              <MDBDropdown>
                ...
                <MDBDropdownMenu>
                  ...
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Home2'}>
                    Homepage 2
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Home3'}>
                    Homepage 3
                  </MDBDropdownItem>
                  <MDBDropdown>
                    <MDBDropdownToggle nav caret>
            ...
            <MDBNavItem>
              <MDBDropdown>
                ...
                <MDBDropdownMenu>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/It_consultancy'}>
                    IT Consultancy
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Digital_services'}>
                    Digital Services
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Advisory_services'}>
                    Advisory Services
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Data_structuring'}>
                    Data Structuring
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Experience_design'}>
                    Experience Design
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Content_engineering'}>
                    Content Engineering
                  </MDBDropdownItem>
                </MDBDropdownMenu>
              </MDBDropdown>
            ...
            <MDBNavItem>
              <MDBDropdown>
                ...
                <MDBDropdownMenu>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Project_style1'}>
                    Project Style 1
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Project_style2'}>
                    Project Style 2
                  </MDBDropdownItem>
                  <MDBDropdown>
                    <MDBDropdownToggle nav caret>
                    ...
                    <MDBDropdownMenu>
                      <MDBDropdownItem href={process.env.PUBLIC_URL + '/Single_style1'}>
                        Single Style 01
                      </MDBDropdownItem>
                      <MDBDropdownItem href={process.env.PUBLIC_URL + '/Single_style2'}>
                        Single Style 02
                      </MDBDropdownItem>
                      <MDBDropdownItem href={process.env.PUBLIC_URL + '/Single_style3'}>
                        Single Style 03
                      </MDBDropdownItem>
                    </MDBDropdownMenu>
                  </MDBDropdown>
            ...
            <MDBNavItem>
              <MDBDropdown>
                ...
                <MDBDropdownMenu>
                  ...
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Blog_top_image'}>
                    Blog Top Image
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Blog_left_image'}>
                    Blog Left Image
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Single_blog'}>
                    Blog Single View
                  </MDBDropdownItem>
                </MDBDropdownMenu>
              </MDBDropdown>
            ...
            <MDBNavItem>
              <MDBDropdown>
                ...
                <MDBDropdownMenu>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Shop'}>
                    Default Shop
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Product_details'}>
                    Single Product Details
                  </MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Cart'}>Cart</MDBDropdownItem>
                  <MDBDropdownItem href={process.env.PUBLIC_URL + '/Checkout'}>
                    Checkout
                  </MDBDropdownItem>
                </MDBDropdownMenu>
              </MDBDropdown>
